...
import CountDown from "../../components/IT22577160/CountDown";
...
import {
  addToRating,
  removeFromRating,
} from "../../redux/IT22577160/ratingSlice.js";
...
export default function MarketPlace() {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      const res = await fetch("/api/inventory/getInventoryItems");
        ...
        <div className="flex flex-col sm:flex-row p-3 border border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center">
          <div className="flex justify-center flex-col flex-1">
            ...
            <p className="text-gray-500 my-2">
              ...
              Consequatur, reiciendis veniam sapiente deserunt ut nihil
              necessitatibus provident earum. Sunt ducimus unde voluptates vel
              omnis maxime sint velit laudantium officiis consectetur eveniet id
              qui earum ipsum culpa, quos blanditiis, odit, fugit reprehenderit
              distinctio? Dolorem similique eum quibusdam? Quasi, commodi
              dignissimos! Doloribus reprehenderit vitae officia iusto harum
              provident blanditiis amet deserunt perferendis, aliquid repellat
              aspernatur animi labore nulla asperiores nesciunt aliquam optio
              esse culpa facere sunt sequi veniam! Ipsam ea totam perspiciatis
              sed ipsa a? Voluptate alias quibusdam omnis tempora. Aperiam
              nostrum voluptatum atque, ad pariatur eaque eligendi deserunt quis
              natus vitae!
            </p>
          ...
          <div className="flex-1 p-7">
            <img src={market} alt="" className="rounded-md" />
          </div>
        </div>
      </div>
