...
import { removeFromWishlist } from "../../redux/IT22577160/wishListSlice.js";
import { addToCart } from "../../redux/IT22577160/cartSlice.js";

export default function WishListPopUp({setOpenWishlist}) {
        ...
        {wishlist && wishlist.length === 0 ? (
          <div className="w-full h-screen flex items-center justify-center">
            <div className="flex w-full justify-end pt-5 pr-5 fixed top-3 right-3">
              <RxCross1
                size={25}
                className="cursor-pointer text-slate-600 border border-teal-500 rounded-md"
                ...
                {wishlist &&
                  wishlist.map((i, index) => (
                    <CartSingle
                      data={i}
                      key={index}
                      removeFormWishlistHandler={removeFormWishlistHandler}
  ...
  return (
    <div className="border-b border-teal-500 p-4 w-full">
      <div className="w-full flex items-center">
        <RxCross1
          className="cursor-pointer text-slate-600 font-bold border border-teal-500 rounded-md"
        ...
        />
        <div className="">
          <h1 className="text-sm text-gray-600 line-clamp-2 w-52">
            {data.title}
          </h1>
